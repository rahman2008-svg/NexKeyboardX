...
/**
 * Utility class for handling 2D coordinate data used in gesture typing,
 * swipe input tracking, and touch path processing.
 *
 * Coordinates are stored in flat int arrays for performance optimization.
 */
public final class CoordinateUtils {
    ...
    public static void copy(@Nonnull final int[] destination,
                            @Nonnull final int[] source) {
    ...
    public static int xFromArray(@Nonnull final int[] coordsArray,
                                 final int index) {

        return coordsArray[ELEMENT_SIZE * index + INDEX_X];
    }

    public static int yFromArray(@Nonnull final int[] coordsArray,
                                 final int index) {
    ...
    @Nonnull
    public static int[] coordinateFromArray(@Nonnull final int[] coordsArray,
                                            final int index) {

        final int[] coords = newInstance();

        set(coords,
            xFromArray(coordsArray, index),
            yFromArray(coordsArray, index)
        );

        return coords;
    }

    public static void setXYInArray(@Nonnull final int[] coordsArray,
                                    final int index,
                                    final int x,
                                    final int y) {
    ...
    public static void setCoordinateInArray(@Nonnull final int[] coordsArray,
                                            final int index,
